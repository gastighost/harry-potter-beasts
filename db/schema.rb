...
ActiveRecord::Schema.define(version: 2022_02_23_110339) do
  ...
  create_table "reviews", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["creature_id"], name: "index_reviews_on_creature_id"
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.integer "years_of_magic"
    t.boolean "owner"
    t.boolean "dark_magic"
  ...
  add_foreign_key "reviews", "creatures"
