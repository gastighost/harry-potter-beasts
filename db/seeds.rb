...
def creating_beasts(user)
  ...
  years = rand(1..350)
  Creature.create!(name: Faker::Movies::HarryPotter.character, category: "Beasts", breed: beasts,
...
def creating_beings(user)
  ...
  years = rand(1..350)
  Creature.create!(name: Faker::Movies::HarryPotter.character, category: "Beings", breed: beings,
                   super_power: Faker::Movies::HarryPotter.spell, needed_years_magic: years, user: user)
end
...
def creating_spirits(user)
  ...
  years = rand(1..350)
  Creature.create!(name: Faker::Movies::HarryPotter.character, category: "Spirits", breed: spirits,
                   super_power: Faker::Movies::HarryPotter.spell, needed_years_magic: years, user: user)
end
